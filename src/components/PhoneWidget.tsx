...
export function PhoneWidget() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[340px]">
      {/* glow */}
      <div className="absolute -inset-6 -z-10 rounded-[3rem] bg-ink/5 blur-2xl" />

      {/* phone frame */}
      <div className="relative rounded-[2.75rem] border border-line bg-paper p-3 shadow-lift">
        <div className="rounded-[2.25rem] bg-mist/60 px-5 py-6">
          {/* notch */}
          <div className="mx-auto mb-5 h-1.5 w-16 rounded-full bg-ink/15" />

          {/* status row */}
          <div className="mb-5 flex items-center justify-between text-[11px] font-medium text-ink/45">
            <span>9:41</span>
          ...
          <div className="mt-5 overflow-hidden rounded-xl border border-line bg-paper px-4 py-3">
          ...
          {/* booked row */}
          <div className="mt-3 flex items-center gap-3 rounded-xl border border-line bg-paper px-4 py-3">
